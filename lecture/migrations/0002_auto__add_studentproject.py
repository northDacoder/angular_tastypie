...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'lecture_studentproject', (
            ...
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lecture.Student'])),
    ...
    models = {
        ...
        u'lecture.studentproject': {
            ...
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['lecture.Student']"})
        }
    }
